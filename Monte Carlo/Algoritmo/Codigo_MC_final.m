...
bias_cov = xlsread(filePath, 'bias y CoV para matlab', 'A2:I3'); % Se extraen factor bias y coeficientes de variación

% Leer datos de diseño de las vigas (desde la fila 3, columnas c a I)
valores_diseno = xlsread(filePath, 'Datos vigas para matlab', 'C3:I162'); % Especificar rango de celdas con valores de diseño
...
for i = 1:num_vigas
    ...
    solicitante_modelo = lognrnd(lambda_S, sqrt(zeta_S), N, 1);
        ...
        alfa_gumbel = (cov_carga_viva*bias_carga_viva*M_vivo_diseno) * sqrt(6) / pi; % Parámetro de escala entre paréntesis la desvesta
        un_gumbel = bias_carga_viva*M_vivo_diseno - gamma * alfa_gumbel; % Parámetro de ubicación
